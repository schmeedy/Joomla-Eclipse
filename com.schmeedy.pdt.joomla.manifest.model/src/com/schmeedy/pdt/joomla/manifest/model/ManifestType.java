...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Manifest Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.schmeedy.pdt.joomla.manifest.model.JoomlaExtensionManifestPackage#getManifestType()
 * @model
 * @generated
 */
public enum ManifestType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Manifest Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ManifestType[] VALUES_ARRAY =
		new ManifestType[] {
			UNKNOWN,
			COMPONENT,
			PLUGIN,
	...
	/**
	 * A public read-only list of all the '<em><b>Manifest Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ManifestType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Manifest Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ManifestType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ManifestType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Manifest Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ManifestType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ManifestType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Manifest Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ManifestType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ManifestType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
