...
public class JoomlaProjectModelPackageImpl extends EPackageImpl implements JoomlaProjectModelPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getJoomlaExtensionProject_Extensions(), this.getBasicExtensionModel(), null, "extensions", null, 0, -1, JoomlaExtensionProject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
